...
public class RecyclerViewContactAnimationAdapter extends RecyclerView.Adapter<RecyclerViewContactAnimationAdapter.ViewHolder> {

    Context context;
    ArrayList<ContactModel> arrContacts;
    private int lastPosition = -1;

    RecyclerViewContactAnimationAdapter(Context context, ArrayList<ContactModel> arrContacts) {
    ...
    @NonNull
    @Override
    public RecyclerViewContactAnimationAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RecyclerViewContactAnimationAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
